...
require (
	...
	github.com/micro/go-plugins v0.21.1
...
replace (
	...
	github.com/yametech/fuxi/pkg/db => ./pkg/db
	github.com/yametech/fuxi/srv/ops => ./srv/ops
	...
	k8s.io/client-go => k8s.io/client-go v12.0.0+incompatible // 1.15.6
