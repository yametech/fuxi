...
import (
	...
	skpError "github.com/yametech/fuxi/pkg/docker/error"
	"github.com/yametech/fuxi/pkg/docker/templates"
...
func Inspect(out io.Writer, references []string, tmplStr string, getRef GetRefFunc) error {
	...
	if err != nil {
		return skpError.StatusError{StatusCode: 64, Status: err.Error()}
	}
