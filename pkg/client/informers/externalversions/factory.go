...
import (
	...
	fuxi "github.com/yametech/fuxi/pkg/client/informers/externalversions/fuxi"
...
func (f *sharedInformerFactory) Fuxi() fuxi.Interface {
	return fuxi.New(f, f.namespace, f.tweakListOptions)
}
