...
import (
	// appsv1beta1 "k8s.io/api/apps/v1beta1"  // incompatible after 1.15
...
const (
	...
	// nuwa CRD resource
	ResourceNameNuwasts ResourceName = "statefulsets"
	ResourceNameNuwawts ResourceName = "waters"
	ResourceNameNuwaste ResourceName = "stones"
	ResourceNameNuwainj ResourceName = "injectors"
)
...
const (
	...
	// nuwa CRD resource
	KindNameNuwasts KindName = "Statefulset"
	KindNameNuwawts KindName = "Water"
	KindNameNuwaste KindName = "Stone"
	KindNameNuwainj KindName = "Injector"
)
...
var KindToResourceMap = map[ResourceName]ResourceMap{
...
var CRDResourceMap = map[ResourceName]schema.GroupVersionKind{
	ResourceNameNuwasts: nuwav1.GVK(ResourceNameNuwasts),
	ResourceNameNuwawts: nuwav1.GVK(ResourceNameNuwawts),
	ResourceNameNuwaste: nuwav1.GVK(ResourceNameNuwaste),
	ResourceNameNuwainj: nuwav1.GVK(ResourceNameNuwainj),
}
